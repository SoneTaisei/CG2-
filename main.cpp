...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	*********************************************************/
	...
	vertexResourceDesc.Width = sizeof(VertexData) * 3;// どのくらいデータを使うかをGPUに伝える。三角形は三点なので*3
	// バッファの場合はこれらは1にする決まり
	...
	vertexBufferView.SizeInBytes = sizeof(VertexData) * 3;// 何バイト分かを書く
	// 1頂点当たりのサイズ
